...
The three iterations were tested with the EIL51 dataset with a population size of 500 and an iteration count of 10000. The resulting speedups are shown in Figure \ref{fig:versions}. As can be seen, %TODO finish AFTER THE FINAL 1-5 TESTING
